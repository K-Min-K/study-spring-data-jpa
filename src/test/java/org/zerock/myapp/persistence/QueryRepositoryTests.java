...
//    @RepeatedTest(1)
    ...
    void testQueryMethod_2() {
        ...
        Page<Board> page = this.dao.queryMethod_2(searchPattern,paging);
...
//    @RepeatedTest(1)
    ...
    void testQueryMethod_4() {
        ...
        final String pattern = "%TLE%";
        Page paging = PageRequest.of(3, 20, Sort.Direction.ASC, "id");
...
//    @RepeatedTest(1)
 ...
 //       final String pattern = "%TLE%";
        ...
        Page paging = PageRequest.of(1, 7, Sort.Direction.ASC, "board_id");
